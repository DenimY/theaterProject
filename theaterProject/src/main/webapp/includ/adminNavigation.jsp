		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Dashboard"><a class="nav-link" href="#" onClick="adminMenu('dashBoard')">
						<i class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text">Dashboard</span>
				</a></li>
<!-- 				<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts"><a class="nav-link" href="#" onClick="adminMenu('charts')"> -->
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="#" onClick="adminMenu('charts')"> 
					<i class="fa fa-fw fa-area-chart"></i> <span class="nav-link-text">Charts</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="userInfotables"><a class="nav-link"
					href="#" onClick="adminMenu('userInfo')"> <i class="fa fa-fw fa-table"></i> <span
						class="nav-link-text">UserInfo</span>
				</a></li>
<!-- 				<li class="nav-item" data-toggle="tooltip" data-placement="right" -->
<!-- 					title="Components"><a -->
...
<!-- 						fa-file-> fawrench -->
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="#collapseExamplePages" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-wrench"></i> <span class="nav-link-text">Management Tool</span>
				</a>
